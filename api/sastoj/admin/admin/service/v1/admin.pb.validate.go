...
// Validate checks the field values on GetReferenceAnswerRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetReferenceAnswerRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetReferenceAnswerRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetReferenceAnswerRequestMultiError, or nil if none found.
func (m *GetReferenceAnswerRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetReferenceAnswerRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetReferenceAnswerRequestMultiError(errors)
	}

	return nil
}

// GetReferenceAnswerRequestMultiError is an error wrapping multiple validation
// errors returned by GetReferenceAnswerRequest.ValidateAll() if the
// designated constraints aren't met.
type GetReferenceAnswerRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetReferenceAnswerRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetReferenceAnswerRequestMultiError) AllErrors() []error { return m }

// GetReferenceAnswerRequestValidationError is the validation error returned by
// GetReferenceAnswerRequest.Validate if the designated constraints aren't met.
type GetReferenceAnswerRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetReferenceAnswerRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetReferenceAnswerRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetReferenceAnswerRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetReferenceAnswerRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetReferenceAnswerRequestValidationError) ErrorName() string {
	return "GetReferenceAnswerRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetReferenceAnswerRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetReferenceAnswerRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetReferenceAnswerRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetReferenceAnswerRequestValidationError{}

// Validate checks the field values on GetReferenceAnswerReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetReferenceAnswerReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetReferenceAnswerReply with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetReferenceAnswerReplyMultiError, or nil if none found.
func (m *GetReferenceAnswerReply) ValidateAll() error {
	return m.validate(true)
}

func (m *GetReferenceAnswerReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetReferenceAnswerReplyMultiError(errors)
	}

	return nil
}

// GetReferenceAnswerReplyMultiError is an error wrapping multiple validation
// errors returned by GetReferenceAnswerReply.ValidateAll() if the designated
// constraints aren't met.
type GetReferenceAnswerReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetReferenceAnswerReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetReferenceAnswerReplyMultiError) AllErrors() []error { return m }

// GetReferenceAnswerReplyValidationError is the validation error returned by
// GetReferenceAnswerReply.Validate if the designated constraints aren't met.
type GetReferenceAnswerReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetReferenceAnswerReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetReferenceAnswerReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetReferenceAnswerReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetReferenceAnswerReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetReferenceAnswerReplyValidationError) ErrorName() string {
	return "GetReferenceAnswerReplyValidationError"
}

// Error satisfies the builtin error interface
func (e GetReferenceAnswerReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetReferenceAnswerReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetReferenceAnswerReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetReferenceAnswerReplyValidationError{}
