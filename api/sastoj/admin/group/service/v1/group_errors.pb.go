...
func IsGroupExisted(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == ErrorReason_GROUP_EXISTED.String() && e.Code == 400
}

func ErrorGroupExisted(format string, args ...interface{}) *errors.Error {
	return errors.New(400, ErrorReason_GROUP_EXISTED.String(), fmt.Sprintf(format, args...))
}
