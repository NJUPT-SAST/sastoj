...
const (
	Group_CreateGroup_FullMethodName = "/api.sastoj.admin.group.service.v1.Group/CreateGroup"
	Group_UpdateGroup_FullMethodName = "/api.sastoj.admin.group.service.v1.Group/UpdateGroup"
	Group_DeleteGroup_FullMethodName = "/api.sastoj.admin.group.service.v1.Group/DeleteGroup"
	Group_GetGroup_FullMethodName    = "/api.sastoj.admin.group.service.v1.Group/GetGroup"
	Group_ListGroup_FullMethodName   = "/api.sastoj.admin.group.service.v1.Group/ListGroup"
)
...
func (c *groupClient) ListGroup(ctx context.Context, in *ListGroupRequest, opts ...grpc.CallOption) (*ListGroupReply, error) {
	...
	err := c.cc.Invoke(ctx, Group_ListGroup_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Group_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.sastoj.admin.group.service.v1.Group",
	...
	Metadata: "sastoj/admin/group/service/v1/group.proto",
}
