...
const (
	Problem_CreateProblem_FullMethodName = "/api.sastoj.admin.problem.Problem/CreateProblem"
	Problem_UpdateProblem_FullMethodName = "/api.sastoj.admin.problem.Problem/UpdateProblem"
	Problem_DeleteProblem_FullMethodName = "/api.sastoj.admin.problem.Problem/DeleteProblem"
	Problem_ListProblem_FullMethodName   = "/api.sastoj.admin.problem.Problem/ListProblem"
	Problem_GetProblem_FullMethodName    = "/api.sastoj.admin.problem.Problem/GetProblem"
)
...
func (c *problemClient) CreateProblem(ctx context.Context, in *CreateProblemRequest, opts ...grpc.CallOption) (*CreateProblemReply, error) {
	...
	err := c.cc.Invoke(ctx, Problem_CreateProblem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *problemClient) UpdateProblem(ctx context.Context, in *UpdateProblemRequest, opts ...grpc.CallOption) (*UpdateProblemReply, error) {
	...
	err := c.cc.Invoke(ctx, Problem_UpdateProblem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *problemClient) DeleteProblem(ctx context.Context, in *DeleteProblemRequest, opts ...grpc.CallOption) (*DeleteProblemReply, error) {
	...
	err := c.cc.Invoke(ctx, Problem_DeleteProblem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *problemClient) ListProblem(ctx context.Context, in *ListProblemRequest, opts ...grpc.CallOption) (*ListProblemReply, error) {
	...
	err := c.cc.Invoke(ctx, Problem_ListProblem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Problem_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.sastoj.admin.problem.Problem",
