...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	r := s.Route("/")
	r.POST("/api.sastoj.admin.user.service.v1.User/CreateUser", _User_CreateUser0_HTTP_Handler(srv))
	r.POST("/api.sastoj.admin.user.service.v1.User/UpdateUser", _User_UpdateUser0_HTTP_Handler(srv))
	r.POST("/api.sastoj.admin.user.service.v1.User/DeleteUser", _User_DeleteUser0_HTTP_Handler(srv))
	r.POST("/api.sastoj.admin.user.service.v1.User/GetUser", _User_GetUser0_HTTP_Handler(srv))
	r.POST("/api.sastoj.admin.user.service.v1.User/ListUser", _User_ListUser0_HTTP_Handler(srv))
}
...
func (c *UserHTTPClientImpl) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...http.CallOption) (*CreateUserReply, error) {
	...
	pattern := "/api.sastoj.admin.user.service.v1.User/CreateUser"
...
func (c *UserHTTPClientImpl) DeleteUser(ctx context.Context, in *DeleteUserRequest, opts ...http.CallOption) (*DeleteUserReply, error) {
	...
	pattern := "/api.sastoj.admin.user.service.v1.User/DeleteUser"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *UserHTTPClientImpl) GetUser(ctx context.Context, in *GetUserRequest, opts ...http.CallOption) (*GetUserReply, error) {
	...
	pattern := "/api.sastoj.admin.user.service.v1.User/GetUser"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *UserHTTPClientImpl) ListUser(ctx context.Context, in *ListUserRequest, opts ...http.CallOption) (*ListUserReply, error) {
	...
	pattern := "/api.sastoj.admin.user.service.v1.User/ListUser"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *UserHTTPClientImpl) UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...http.CallOption) (*UpdateUserReply, error) {
	...
	pattern := "/api.sastoj.admin.user.service.v1.User/UpdateUser"
	path := binding.EncodeURL(pattern, in, true)
