...
const (
	Judge_ListAllStatus_FullMethodName = "/sastoj.gojudge.judger.service.v1.Judge/ListAllStatus"
)
...
func (c *judgeClient) ListAllStatus(ctx context.Context, in *ListAllStatusRequest, opts ...grpc.CallOption) (*ListAllStatusReply, error) {
	...
	err := c.cc.Invoke(ctx, Judge_ListAllStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
