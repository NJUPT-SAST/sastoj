...
var file_sastoj_user_contest_service_v1_contest_proto_goTypes = []any{
	...
	(*ListRankingReply_User)(nil),              // 35: api.sastoj.user.contest.service.v1.ListRankingReply.User
...
var file_sastoj_user_contest_service_v1_contest_proto_depIdxs = []int32{
	...
	36, // 4: api.sastoj.user.contest.service.v1.GetSubmissionReply.created_at:type_name -> google.protobuf.Timestamp
	...
	35, // 7: api.sastoj.user.contest.service.v1.ListRankingReply.users:type_name -> api.sastoj.user.contest.service.v1.ListRankingReply.User
	36, // 8: api.sastoj.user.contest.service.v1.GetContestsReply.Contest.start_time:type_name -> google.protobuf.Timestamp
	36, // 9: api.sastoj.user.contest.service.v1.GetContestsReply.Contest.end_time:type_name -> google.protobuf.Timestamp
	...
	36, // 11: api.sastoj.user.contest.service.v1.GetSubmissionsReply.Submission.created_at:type_name -> google.protobuf.Timestamp
	0,  // 12: api.sastoj.user.contest.service.v1.Contest.GetContests:input_type -> api.sastoj.user.contest.service.v1.GetContestsRequest
	2,  // 13: api.sastoj.user.contest.service.v1.Contest.JoinContest:input_type -> api.sastoj.user.contest.service.v1.JoinContestRequest
	4,  // 14: api.sastoj.user.contest.service.v1.Contest.GetProblems:input_type -> api.sastoj.user.contest.service.v1.GetProblemsRequest
	6,  // 15: api.sastoj.user.contest.service.v1.Contest.GetProblem:input_type -> api.sastoj.user.contest.service.v1.GetProblemRequest
	8,  // 16: api.sastoj.user.contest.service.v1.Contest.Submit:input_type -> api.sastoj.user.contest.service.v1.SubmitRequest
	10, // 17: api.sastoj.user.contest.service.v1.Contest.SelfTest:input_type -> api.sastoj.user.contest.service.v1.SelfTestRequest
	12, // 18: api.sastoj.user.contest.service.v1.Contest.GetSubmission:input_type -> api.sastoj.user.contest.service.v1.GetSubmissionRequest
	14, // 19: api.sastoj.user.contest.service.v1.Contest.GetSubmissions:input_type -> api.sastoj.user.contest.service.v1.GetSubmissionsRequest
	16, // 20: api.sastoj.user.contest.service.v1.Contest.GetSelfTest:input_type -> api.sastoj.user.contest.service.v1.GetSelfTestRequest
	18, // 21: api.sastoj.user.contest.service.v1.Contest.GetCases:input_type -> api.sastoj.user.contest.service.v1.GetCasesRequest
	20, // 22: api.sastoj.user.contest.service.v1.Contest.ListRanking:input_type -> api.sastoj.user.contest.service.v1.ListRankingRequest
	26, // 23: api.sastoj.user.contest.service.v1.Contest.Register:input_type -> api.sastoj.user.contest.service.v1.RegisterRequest
	22, // 24: api.sastoj.user.contest.service.v1.Contest.UpdateSubmission:input_type -> api.sastoj.user.contest.service.v1.UpdateSubmissionRequest
	24, // 25: api.sastoj.user.contest.service.v1.Contest.UpdateSelfTest:input_type -> api.sastoj.user.contest.service.v1.UpdateSelfTestRequest
	1,  // 26: api.sastoj.user.contest.service.v1.Contest.GetContests:output_type -> api.sastoj.user.contest.service.v1.GetContestsReply
	3,  // 27: api.sastoj.user.contest.service.v1.Contest.JoinContest:output_type -> api.sastoj.user.contest.service.v1.JoinContestReply
	5,  // 28: api.sastoj.user.contest.service.v1.Contest.GetProblems:output_type -> api.sastoj.user.contest.service.v1.GetProblemsReply
	7,  // 29: api.sastoj.user.contest.service.v1.Contest.GetProblem:output_type -> api.sastoj.user.contest.service.v1.GetProblemReply
	9,  // 30: api.sastoj.user.contest.service.v1.Contest.Submit:output_type -> api.sastoj.user.contest.service.v1.SubmitReply
	11, // 31: api.sastoj.user.contest.service.v1.Contest.SelfTest:output_type -> api.sastoj.user.contest.service.v1.SelfTestReply
	13, // 32: api.sastoj.user.contest.service.v1.Contest.GetSubmission:output_type -> api.sastoj.user.contest.service.v1.GetSubmissionReply
	15, // 33: api.sastoj.user.contest.service.v1.Contest.GetSubmissions:output_type -> api.sastoj.user.contest.service.v1.GetSubmissionsReply
	17, // 34: api.sastoj.user.contest.service.v1.Contest.GetSelfTest:output_type -> api.sastoj.user.contest.service.v1.GetSelfTestReply
	19, // 35: api.sastoj.user.contest.service.v1.Contest.GetCases:output_type -> api.sastoj.user.contest.service.v1.GetCasesReply
	21, // 36: api.sastoj.user.contest.service.v1.Contest.ListRanking:output_type -> api.sastoj.user.contest.service.v1.ListRankingReply
	27, // 37: api.sastoj.user.contest.service.v1.Contest.Register:output_type -> api.sastoj.user.contest.service.v1.RegisterReply
	23, // 38: api.sastoj.user.contest.service.v1.Contest.UpdateSubmission:output_type -> api.sastoj.user.contest.service.v1.UpdateSubmissionReply
	25, // 39: api.sastoj.user.contest.service.v1.Contest.UpdateSelfTest:output_type -> api.sastoj.user.contest.service.v1.UpdateSelfTestReply
...
func file_sastoj_user_contest_service_v1_contest_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_sastoj_user_contest_service_v1_contest_proto_msgTypes[34].Exporter = func(v any, i int) any {
		...
		file_sastoj_user_contest_service_v1_contest_proto_msgTypes[35].Exporter = func(v any, i int) any {
