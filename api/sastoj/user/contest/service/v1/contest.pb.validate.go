...
// Validate checks the field values on GetCasesReply_Subtask with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetCasesReply_Subtask) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetCasesReply_Subtask with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetCasesReply_SubtaskMultiError, or nil if none found.
func (m *GetCasesReply_Subtask) ValidateAll() error {
	return m.validate(true)
}

func (m *GetCasesReply_Subtask) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetCases() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GetCasesReply_SubtaskValidationError{
			...
			if err := v.Validate(); err != nil {
				return GetCasesReply_SubtaskValidationError{
					field:  fmt.Sprintf("Cases[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return GetCasesReply_SubtaskMultiError(errors)
	}

	return nil
}

// GetCasesReply_SubtaskMultiError is an error wrapping multiple validation
// errors returned by GetCasesReply_Subtask.ValidateAll() if the designated
// constraints aren't met.
type GetCasesReply_SubtaskMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetCasesReply_SubtaskMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetCasesReply_SubtaskMultiError) AllErrors() []error { return m }

// GetCasesReply_SubtaskValidationError is the validation error returned by
// GetCasesReply_Subtask.Validate if the designated constraints aren't met.
type GetCasesReply_SubtaskValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetCasesReply_SubtaskValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetCasesReply_SubtaskValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetCasesReply_SubtaskValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetCasesReply_SubtaskValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetCasesReply_SubtaskValidationError) ErrorName() string {
	return "GetCasesReply_SubtaskValidationError"
}

// Error satisfies the builtin error interface
func (e GetCasesReply_SubtaskValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetCasesReply_Subtask.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetCasesReply_SubtaskValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetCasesReply_SubtaskValidationError{}
