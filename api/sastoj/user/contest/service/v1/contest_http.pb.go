...
const OperationContestGetSelfTest = "/api.sastoj.user.contest.service.v1.Contest/GetSelfTest"
const OperationContestGetSubmission = "/api.sastoj.user.contest.service.v1.Contest/GetSubmission"
const OperationContestGetSubmissions = "/api.sastoj.user.contest.service.v1.Contest/GetSubmissions"
...
func _Contest_GetSubmissions0_HTTP_Handler(srv ContestHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationContestGetSubmissions)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *ContestHTTPClientImpl) GetCases(ctx context.Context, in *GetCasesRequest, opts ...http.CallOption) (*GetCasesReply, error) {
	...
	pattern := "/user/contests/{contest_id}/submissions/{submission_id}/cases"
...
func (c *ContestHTTPClientImpl) GetSubmission(ctx context.Context, in *GetSubmissionRequest, opts ...http.CallOption) (*GetSubmissionReply, error) {
	...
	pattern := "/user/contests/{contest_id}/submissions/{submission_id}"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ContestHTTPClientImpl) GetSubmissions(ctx context.Context, in *GetSubmissionsRequest, opts ...http.CallOption) (*GetSubmissionsReply, error) {
	var out GetSubmissionsReply
	pattern := "/user/contests/{contest_id}/problems/{problem_id}/submissions"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationContestGetSubmissions))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
