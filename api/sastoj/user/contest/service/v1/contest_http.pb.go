...
func RegisterContestServiceHTTPServer(s *http.Server, srv ContestServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/user/contest", _ContestService_ListContest1_HTTP_Handler(srv))
...
func _ContestService_ListContest1_HTTP_Handler(srv ContestServiceHTTPServer) func(ctx http.Context) error {
